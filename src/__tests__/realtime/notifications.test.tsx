...
describe('Real-time Notifications Tests', () => {
  ...
  describe('Message Notifications', () => {
    ...
    it('should truncate long message content in notifications', async () => {
      const longMessage = 'This is a very long message that should be truncated when shown in the notification to prevent the notification from being too long and overwhelming'
  ...
  describe('Error Handling', () => {
    it('should handle friend request refresh errors gracefully', async () => {
      const refreshRequests = jest.fn().mockRejectedValue(new Error('API Error'))
