...
import { MessageCircle, Search, Menu, X, UserPlus, Phone, Video, MoreVertical, Users, Plus, RefreshCw } from "lucide-react";
...
export default function MessagesPage() {
  ...
  const ConversationsList = () => {
    ...
    const friendsWithConversations = friends
      ...
      .map(friend => {
        const conversation = conversations.find(conv => conv.participant.id === friend.id);
        return {
          ...friend,
    ...
    return (
      <div className="h-full flex flex-col bg-white">
        ...
        {/* Tabs */}
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'conversations' | 'friends')} className="flex-1 flex flex-col">
          <TabsList className="grid w-full grid-cols-2 mx-4 mt-3 mb-2 bg-gray-100">
            <TabsTrigger value="conversations" className="text-sm">Chats ({friendsWithConversations.length})</TabsTrigger>
            <TabsTrigger value="friends" className="text-sm">Friends ({allFriends.length})</TabsTrigger>
          </TabsList>
            ...
            <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
              {isLoadingConversations ? (
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="text-gray-600 text-sm font-medium">No friends to chat with</p>
                  <p className="text-gray-400 text-xs mt-1">Add friends to start conversations!</p>
                  <Button 
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          selectedConversation?.participant.id === friend.id && "bg-blue-50 border-r-2 border-blue-500"
                        )}
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <h3 className="font-medium text-sm text-gray-900 truncate">{friend.username}</h3>
              ...
              {friendsLoading ? (
                ...
                <div className="divide-y divide-gray-100">
                  {allFriends.map((friend) => (
                    <div
                      key={friend.id}
                      onClick={() => createConversationWithFriend(friend.id)}
  ...
  if (isMobileView) {
    return (
    <div className="h-[calc(100vh-5rem)] flex overflow-hidden rounded-lg shadow-sm border border-gray-200 bg-white my-2">
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center bg-gray-50 p-6">
                <div className="text-center max-w-sm mx-auto">
                  ...
                  <Button onClick={() => setSidebarOpen(true)} className="w-full">
  ...
  return (
    <div className="h-[calc(100vh-5rem)] flex bg-white overflow-hidden rounded-lg shadow-sm border border-gray-200 my-2">
        ...
        {selectedConversation ? (
          <div className="h-full flex flex-col">
            ...
            <div className="md:hidden flex items-center p-4 border-b bg-white">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-sm">{selectedConversation.participant.username}</h3>
          ...
          <div className="h-full flex items-center justify-center bg-gray-50">
            <div className="text-center max-w-md mx-auto px-6">
              {/* Mobile: Show menu button to open conversations */}
              <div className="md:hidden mb-6">
                <Button onClick={() => setSidebarOpen(true)} size="lg" className="w-full bg-green-600 hover:bg-green-700">
                  <Menu className="mr-2 h-5 w-5" />
                  Open Messages
                </Button>
              </div>
              
              {/* Desktop and Mobile: Welcome message */}
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-6">
                  <span className="md:hidden">Tap "Open Messages" to see your conversations and start chatting with friends.</span>
                  <span className="hidden md:inline">Select a conversation from the sidebar to start messaging, or go to the Friends page to connect with new people.</span>
                </p>
